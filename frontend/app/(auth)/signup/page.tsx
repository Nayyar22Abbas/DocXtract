...
import { API_BASE, signup } from "@/lib/api/auth"
...
export default function SignupPage() {
  ...
  const handleOAuth = (provider: 'google' | 'github') => {
    ...
    const target = `${API_BASE}/authuser/login/${provider}`
      ...
      >
        <Card className="glass-effect border-primary/20">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>Sign up to start using DocXtract</CardDescription>
          </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter your name" {...field} className="h-11" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
