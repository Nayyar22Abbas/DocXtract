              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-muted/50 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    📝 This is a frontend-only demo. Document processing is not available without backend integration.
                  </p>
                </div>
                <p className="text-sm text-muted-foreground">
                  In a full implementation, this page would display the AI-generated summary of your document.
                </p>
              </CardContent>
            </Card>
          </motion.div>
